...
systems** programming. In addition, I like creating **open-source packages** for
platforms such as npm.
...
- **CEMU** – A CHIP-8 emulator written in C using SDL3.
- **CASM** – Assembler for CHIP-8 instruction set with its own Assembly
specification.
- **LangChain Boilerplate** – AI agent boilerplate with RAG built with
TypeScript using LangChain.
- **AFL Presence** *(WIP)* – School student attendance tracking system.
-  **Spyder** *(WIP)* - A schema-based web scraping toolkit for data extraction.
...
<p align="center">
    <a href="mailto:jlucasmelob558@gmail.com">
        <img src="https://img.shields.io/badge/Email-EA4335?style=for-the-badge&logo=gmail&logoColor=white" alt="Email">
    </a>
    <a href="https://www.reddit.com/user/lucaaszsx">
        <img src="https://img.shields.io/badge/Reddit-FF4500?style=for-the-badge&logo=reddit&logoColor=white" alt="Reddit">
    </a>
    <a href="https://x.com/lucaaszsx">
...
If you'd like to connect, discuss a project, or simply have a conversation, feel free to reach out through any of the platforms listed above.